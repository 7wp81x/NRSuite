...
The Wi-Fi module uses the ESP32's built-in 2.4 GHz radio — no external antenna needed. Future modules (NRF24, CC1101, IR) will use external add-on hardware — see the [Features checklist](../README.md#features).
